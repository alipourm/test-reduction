 ...
 * Git version: 30dccd7
 * Options:   --argc --no-arrays --no-bitfields --checksum --comma-operators --compound-assignment --consts --no-divs --embedded-assigns --pre-incr-operator --no-pre-decr-operator --post-incr-operator --no-post-decr-operator --no-unary-plus-operator --no-jumps --longlong --int8 --uint8 --no-float --no-math64 --no-inline-function --no-muls --safe-math --packed-struct --paranoid --pointers --no-structs --no-unions --no-volatiles --volatile-pointers --no-const-pointers -o /project/alipour/c-testcases/swarm/tc617.c
 * Seed:      2373673399
 */
...
/* --- GLOBAL VARIABLES --- */
static int32_t g_3 = 0x3198A8F9L;
static uint16_t g_15 = 0x20A2L;
